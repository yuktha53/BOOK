...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String nam="hkjn";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +"(ID INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT,EMAILID TEXT,BOOK_NAME TEXT,AUTHOR TEXT,PRICE INTEGER)");
    ...
    public boolean insertData(String name,String emailid,String bookname,String author,String price)
    {
